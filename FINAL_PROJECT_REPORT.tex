...
\begin{itemize}
    \item \textbf{Hybrid System}: Precision@5 = 0.8240, Recall@5 = 0.9120, MRR = 0.7450.
    \item \textbf{Keyword Baseline}: Precision@5 = 0.5420, Recall@5 = 0.6840, MRR = 0.5120.
\end{itemize}

The results demonstrate a significant improvement (approx. 45\% gain in MRR) when using hybrid retrieval. This is attributed to the system's ability to catch latent semantic connections (e.g., matching "ML" to "Artificial Intelligence") and enforcing professional constraints like funding stage and role compatibility.
